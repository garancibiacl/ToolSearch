...
export default function App() {
  const [active, setActive] = useState(
    () => localStorage.getItem("active-tab") || "banner"
  );
              ...
              <div>
                ...
                {active === "banner" ? (
                  <p className="text-slate-400 text-sm mt-1">
                    Gestiona y busca banners HTML con código optimizado para
                    email marketing
                  </p>
                ) : active === "dashboard" ? (
                  <p className="text-slate-400 text-sm mt-1">
                    Bienvenido a tu centro de herramientas de desarrollo
                  </p>
                ) : (
                  <p className="text-slate-400 text-sm mt-1">
                    Sistema de cuadrícula para componer interfaces rápidamente
                  </p>
                )}
              </div>
            </div>
